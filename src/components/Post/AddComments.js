...
function AddComments({ userData , postData , currentUserObj }) {
    ...
    const handleOnEnter = () => {
        ...
        let obj={
            ...
            Text:text,
            ProfilePic:currentUserObj.ProfileUrl   
        }
    ...
    return (
        <div className='commentField'>
            ...
            <Button
             ...
             disabled={text == '' ? true : false} className={classes.cbtn} color='primary'>Post</Button>
        </div>
    )
}
